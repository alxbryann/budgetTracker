...
import com.alxbryann.foc.view.Drawer;
...
public class WindowsTabbed {
    ...
    public void install(JFrame frame, JPanel body) {
        ...
        // Hacer que la barra de menú se vea como parte de la barra de título
        menuBar.putClientProperty(FlatClientProperties.STYLE, ""
                + "borderColor:null;"
                + "border:0,0,0,0;"
                + "background:#295a4b;" // Color específico para que coincida con la barra de título
                + "margin:0,0,0,0");
        ...
        // Asegurar que no haya separación visual
        frame.getRootPane().putClientProperty(FlatClientProperties.MENU_BAR_EMBEDDED, true);
    }
