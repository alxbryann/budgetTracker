...
public class EditIncome extends JPanel {
    ...
    weekOrMonth.setFont(new Font("Lexend", Font.PLAIN, 14));
        ...
        send.addActionListener(e -> {
            ...
            if (name.isEmpty() || amount.isEmpty() || selectedDate == null) {
                JOptionPane.showMessageDialog(EditIncome.this, "Please complete all the fields.", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(EditIncome.this, "Updated successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void loadIncomeInformation(int id, int dayNumber) {
        try {
            HashMap<String, Object> temporalIncomeInformation = (HashMap<String, Object>) viewController.getInformationOfIncome(id);
            ...
            if (isRepetitive != null) {
                ...
                if (parent != null) {
                    ...
                    if (isIncomeRepetitive && weekOrMonth != null) {
                        ...
                        if (colorLabelRef != null) colorLabelRef.setBounds(45, 350, 100, 20);
                        if (colorComboBox != null) colorComboBox.setBounds(45, 380, 300, 30);
                        ...
                        if (colorLabelRef != null) colorLabelRef.setBounds(45, 290, 100, 20);
                        if (colorComboBox != null) colorComboBox.setBounds(45, 320, 300, 30);
                        for (java.awt.Component comp : parent.getComponents()) {
                            if (comp instanceof RoundedButton) {
                                RoundedButton button = (RoundedButton) comp;
                                if ("Update".equals(button.getText())) {
